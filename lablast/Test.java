public class Test {
    static int Test1() {
        ...
        if (bag.first().equals(students[1])) score += 5;
            ...
            System.out.println("Test1 - first() not working properly.");
        }

        if (bag.last().equals(students[3])) score += 5;
        else {
            System.out.println("Test1 - last() not working properly.");
        }
        ...
        if (lower.equals(students[1])) score += 5;
            ...
            System.out.println("Test1 - lower() not working properly.");
        }

        Student higher = bag.higher(students[2]);
        if (higher.equals(students[0])) score += 5;
        else {
            System.out.println("Test1 - higher() not working properly.");
        }
        ...
        if (ok) score += 30;
            ...
            System.out.println("Test1 - Iterator not working properly.");
        }
        ...
        if (!bag.contains(dummyStudent)) score += 5;
            ...
            System.out.println("Test1 - contains() not working properly.");
        }
        bag.remove(dummyStudent);
        if (!bag.contains(dummyStudent)) score += 5;
        else {
            System.out.println("Test1 - remove() not working properly.");
        }
    ...
    static int Test2() {
        ...
        if (bag.first().equals(students[3])) score += 5;
            ...
            System.out.println("Test2 - first() not working properly.");
        }

        if (bag.last().equals(students[1])) score += 5;
        else {
            System.out.println("Test2 - last() not working properly.");
        }
        ...
        if (lower.equals(students[2])) score += 5;
            ...
            System.out.println("Test2 - lower() not working properly.");
        }

        Student higher = bag.higher(students[2]);
        if (higher.equals(students[4])) score += 5;
        else {
            System.out.println("Test2 - higher() not working properly.");
        }
        ...
        if (ok) score += 30;
            ...
            System.out.println("Test2 - Iterator not working properly.");
        }
        ...
        if (!bag.contains(dummyStudent)) score += 5;
            ...
            System.out.println("Test2 - contains() not working properly.");
        }
        bag.remove(dummyStudent);
        if (!bag.contains(dummyStudent)) score += 5;
        else {
            System.out.println("Test2 - remove() not working properly.");
        }
    ...
    static int Test3() {
        ...
        if (bag.first().equals(students[3])) score += 5;
            ...
            System.out.println("Test3 - first() not working properly.");
        }

        if (bag.last().equals(students[2])) score += 5;
        else {
            System.out.println("Test3 - last() not working properly.");
        }
        ...
        if (lower.equals(students[1])) score += 5;
            ...
            System.out.println("Test3 - lower() not working properly.");
        }

        Student higher = bag.higher(students[0]);
        if (higher.equals(students[2])) score += 5;
        else {
            System.out.println("Test3 - higher() not working properly.");
        }
        ...
        if (ok) score += 30;
            ...
            System.out.println("Test3 - Iterator not working properly.");
        }
        ...
        if (!bag.contains(dummyStudent)) score += 5;
            ...
            System.out.println("Test3 - contains() not working properly.");
        }
        bag.remove(dummyStudent);
        if (!bag.contains(dummyStudent)) score += 5;
        else {
            System.out.println("Test3 - remove() not working properly.");
        }
